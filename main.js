...
length = quick_draw_data_set.length;
number = Math.floor(Math.random() * length);
art = quick_draw_data_set[number];
console.log(art);
document.getElementById("sketck_to_make").innerHTML = "sketch to make : " + art;
timer_counter = 0;
timer_check = "";
drawn_sketch = "";
ansewer_holder = "";
...
function check_sketch() {
    ...
    if(timer_check == "complete" || ansewer_holder == "set"){
        timer_check = "";
        ansewer_holder = "";
        update_canvas();
